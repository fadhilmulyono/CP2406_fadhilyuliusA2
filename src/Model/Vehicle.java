...
public abstract class Vehicle {
    ...
    String id; // unique identifier for each vehicle
    ...
    public Vehicle(Road currentRoad) {
        ...
        currentRoad.getVehiclesOnRoad().add(this); //add this vehicle to the road it drives on.
        colour = randomColour();
    }

    public Vehicle() {
        // dummy vehicle attributes on current road
        id = "000";
        length = 0;
        width = 0;
        speed = 0;
    ...
    private Color randomColour() {
        // draw vehicles in random colors
